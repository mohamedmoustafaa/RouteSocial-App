      ...
      <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        <div className="p-4 md:p-5">
          <form onSubmit={handleSubmit(handleUploadPhoto)} className="space-y-4" action="#">
            <div>
              <input type="file" {...register("photo")} id="photo" className="bg-gray-50 hidden border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="••••••••" required />
              <label htmlFor="photo"   className="flex items-center justify-center my-6 gap-3 p-5 cursor-pointer">
                <i className="fa-solid fa-images fa-2xl"></i>
              </label>
            </div>

            <button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upload Your photo</button>
          </form>
        </div>
      </div>
    </div>
